...
import com.example.csdj.common.exception.CustomException;
import com.example.csdj.common.utils.JsonUtil;
import com.example.csdj.common.utils.StringUtils;
...
public abstract class BaseController {
    protected static final NamedThreadLocal<Integer> errCode = new NamedThreadLocal<Integer>(com.bdqn.common.Constants.ERR_CODE);
    protected static final NamedThreadLocal<String> errMsg = new NamedThreadLocal<String>(com.bdqn.common.Constants.ERR_MSG);
    /**
     * 日期格式
     */
    ...
    @ExceptionHandler(com.bdqn.common.exception.BizException.class)
    @ResponseBody
    public String bizException(com.bdqn.common.exception.BizException e) {
        Integer code = e.getCode();
        String msg = e.getMsg();
        if (code == null) code = 2000;
