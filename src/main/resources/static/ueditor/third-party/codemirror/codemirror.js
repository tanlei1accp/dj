...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            indentLine: operation(function(n, dir) {
                if (isLine(n)) indentLine(n, dir == null ? "smart" : dir ? "templates.committee.dwgl.add" : "subtract");
            }),
        ...
        function indentLine(n, how) {
            if (!how) how = "templates.committee.dwgl.add";
            if (how == "smart") {
            ...
            else if (how == "templates.committee.dwgl.add") indentation = curSpace + options.indentUnit;
    ...
    var commands = CodeMirror.commands = {
        ...
        indentMore: function(cm) {cm.indentSelection("templates.committee.dwgl.add");},
