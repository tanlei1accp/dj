...
(function($){
    dk_slideplayer = function(object,config){
        ...
        this.factory = function(){
            ...
            $(this.obj).prepend(
                "<div style='position:absolute;z-index:20;bottom:8px;right:"+this.config.right+"'></div>"
            );
            $(this.obj + " li").css({
                position:"relative",
                top:"0",
            ...
            $(this.obj + " .dkTitleBg").css({
                ...
                left:"0",
                width:"100%",
                height:_this.height,background:"#000",
                opacity:"0.4",
                overflow:"hidden"
            })
            $(this.obj).prepend(
                "<div class='dkTitle'></div>"
            );
            $(this.obj + " p").each(function(i){			
                $(this).appendTo($(_this.obj + " .dkTitle")).css({
                    ...
                    left:"0",
                    width:"100%",
                    height:_this.height,lineHeight:_this.height,
                    textIndent:"5px",
                    textDecoration:"none",
                    fontSize:_this.size,color:"#FFFFFF",background:"none",opacity:"1",
                    overflow:"hidden"
                });
                if(i!= 0){$(this).hide()}
            });
        ...
        this.resetclass =function(obj,i){
           $(obj).css({
               ...
               fontSize:"12px",
               color:"#ffffff",
               background:"url(partyMember/images/silde-nav.png) no-repeat 0px 0px",
               cursor:"pointer"
           });
            $(obj).eq(i).css({
                color:"#FFFFFF",
                background:"url(partyMember/images/silde-nav.png) no-repeat 0px bottom",
                textDecoration:"none"
            });
        }
        this.factory();
